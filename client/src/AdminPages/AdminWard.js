...
const AdminWard = () => {
  ...
  useEffect(() => {
   ...
   useEffect(() => {
        ...
        if(wards.length>200&&wards.length<401){
            setEntries(25)
          }
          else  if(wards.length>400&&wards.length<701){
            setEntries(50)
          }
           else  if(wards.length>700){
            setEntries(100)
          }
  ...
  return (
    <div>
      <button className="btn btn-primary mt-3 ms-4 mobile-margin" onClick={handleClick}>
        Add Ward
      </button>
      ...
      >
        ...
        >
          ...
          />
          <FaSearch
            style={{ color: "#888", marginLeft: "0px", cursor: "pointer" }}
                ...
                <tr key={row._id}>
                  ...
                  <td style={{ width: "30%" }}>
                    <button
                      ...
                      onClick={() => handleView(row._id, index)}
                    >
                      View
                    </button>
                    <button

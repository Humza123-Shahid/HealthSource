  ...
  const currentData = filteredData.slice(startIndex, startIndex + entries);
    ...
    useEffect(() => {
        ...
        fetchData();
         ...
         useEffect(() => {
              ...
              console.log(surgeryteams.length)
              if(surgeryteams.length>200&&surgeryteams.length<401){
                  setEntries(25)
                }
                else  if(surgeryteams.length>400&&surgeryteams.length<701){
                  setEntries(50)
                }
                 else  if(surgeryteams.length>700){
                  setEntries(100)
                }
    ...
    return (
     <div>
        <button className="btn btn-primary mt-3 ms-4 mobile-margin" onClick={handleClick}>Add Surgery Team</button>
        {/* <div className="container d-flex justify-content-between"> */}
          <h3 className="ms-4 mobile-margin"
        style={{
          margin: "20px 0px 0px 15px",
          padding: "0px",
        }}>Surgery Teams Data</h3>
               <div

...
const handleFilterChange = (event) => {
  ...
  const onChange = (e) => {
    if (
      e.target.value == "" &&
      (e.target.name == "patientId" || e.target.name == "doctorId")
    ) {
          ...
          <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
              <div class="navbar-nav ms-auto py-0">
                ...
                ) : localStorage.getItem("utype") == "user" ? (
                  <Link
                    to="/login"
        ...
        <div class="container">
          ...
          >
            {Array.isArray(doctors) &&
              doctors.slice(0, 3).map((row, index) => {
                      ...
                      >
                        ...
                        <div class="col-12 col-sm-7 h-100 d-flex flex-column">
                          <div class="mt-auto p-4">
                            ...
                            <p class="m-0">
                              {staff?.firstName} has {row.experienceYears} Years
            ...
            <div class="col-xl-4 col-lg-6">
              <div class="bg-light rounded overflow-hidden">
                ...
                <div class="d-flex justify-content-between border-top p-4">
                  ...
                  <div class="d-flex align-items-center">
                    <small class="ms-3">
                      <i class="far fa-eye text-primary me-1"></i>12345
                    </small>
                    <small class="ms-3">
                      <i class="far fa-comment text-primary me-1"></i>123
                    </small>
                  </div>
                </div>
              </div>
